...
| [0030](0030-pre-add-intent-review-and-rollout.md) | Pre-add intent review constraints and compatible rollout (proposes to supersede parts of ADR-0029) | Proposed |
