...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "media_type", sa.Enum("movie", "tv", name="mediatype", native_enum=False), nullable=True
        ),
    ...
    with op.batch_alter_table("blocklist", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_blocklist_source_title"), ["source_title"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_blocklist_torrent_hash"), ["torrent_hash"], unique=False
        )
    ...
    with op.batch_alter_table("download_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_download_history_torrent_hash"), ["torrent_hash"], unique=False
        )
    ...
    with op.batch_alter_table("media_requests", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_media_requests_tmdb_media", ["tmdb_id", "media_type"], unique=False
        )
    ...
    with op.batch_alter_table("downloads", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_downloads_torrent_hash"), ["torrent_hash"], unique=True
        )
    ...
    with op.batch_alter_table("season_requests", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_season_requests_media_request_id"), ["media_request_id"], unique=False
        )
